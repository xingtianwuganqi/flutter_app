    ...
    private void initRewardVideo(final String placementId) {
        ...
        mRewardVideoAd.setAdListener(new ATRewardVideoExListener() {
            ...
            public void onDownloadConfirm(Context context, ATAdInfo atAdInfo, ATNetworkConfirmInfo atNetworkConfirmInfo) {
                MsgTools.pirntMsg("video onDownloadConfirm: " + mPlacementId);
            }

            @Override
            public void onRewardedVideoAdAgainPlayStart(ATAdInfo atAdInfo) {
                MsgTools.pirntMsg("onRewardedVideoAdAgainPlayStart: " + mPlacementId);
            ...
            public void onRewardedVideoAdAgainPlayEnd(ATAdInfo atAdInfo) {
                MsgTools.pirntMsg("onRewardedVideoAdAgainPlayEnd: " + mPlacementId);
            ...
            public void onRewardedVideoAdAgainPlayFailed(AdError adError, ATAdInfo atAdInfo) {
                MsgTools.pirntMsg("onRewardedVideoAdAgainPlayFailed: " + mPlacementId);
            ...
            public void onRewardedVideoAdAgainPlayClicked(ATAdInfo atAdInfo) {
                MsgTools.pirntMsg("onRewardedVideoAdAgainPlayClicked: " + mPlacementId);
            ...
            public void onAgainReward(ATAdInfo atAdInfo) {
                MsgTools.pirntMsg("onAgainReward: " + mPlacementId);
