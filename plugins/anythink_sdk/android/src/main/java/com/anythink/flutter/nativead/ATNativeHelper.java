...
public class ATNativeHelper extends AnythinkSdkPlugin {
    ...
    public ATNativeAdView renderNativeView(final Map<String, Object> settings, final String sceneID, boolean isAdaptiveHeight, boolean fromPlatformView) {
        ...
        MsgTools.pirntMsg("renderNativeView: " + mPlacementId + ", settings: " + (settings != null? settings.toString(): "") + ", scenario: " + sceneID + ", isAdaptiveHeight: " + isAdaptiveHeight);
        NativeAd nativeAd;
...
//        }
    ...
    public void removeNativeAd() {
        MsgTools.pirntMsg("native removeNativeAd: " + mPlacementId);
