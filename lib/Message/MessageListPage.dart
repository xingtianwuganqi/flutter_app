      ...
      Container(
        ...
        child: Row(
          children: [
            CircleAvatar(
              radius: 20,
              backgroundImage: // (data.from_info != null && data.from_info.avator != null && (data.from_info.avator.length ?? 0) > 0) ?
              CachedNetworkImageProvider(ToolConfig.loadImgUrl(data.from_info?.avator ?? '')),
